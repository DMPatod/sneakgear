...
| --- | --- | ---: | ---: | ---: |
| `SneakGear.AI.BehaviorTree.BTTaskSetNextPatrolPoint.AdvancesAndLoops` | Passed | 0.075 | 1 | 0 |
| `SneakGear.AI.GuardAIController.UpdatesBlackboardFromGuardTarget` | Passed | 0.046 | 0 | 0 |
| `SneakGear.AI.GuardCombat.FiringAtPlayerDecreasesPlayerHealth` | Passed | 0.047 | 7 | 0 |
| `SneakGear.Characters.BaseCharacter.DeathOnlyRunsOnce` | Passed | 0.046 | 0 | 0 |
| `SneakGear.Inventory.PlayerInventoryComponent.CannotSelectEmptyWeaponSlot` | Passed | 0.008 | 0 | 0 |
| `SneakGear.Inventory.PlayerInventoryComponent.ConsumableUseRestoresHealthConsumesAndLogs` | Passed | 0.047 | 4 | 0 |
| `SneakGear.Inventory.PlayerInventoryComponent.EquippedItemSwitchLogsAndActivates` | Passed | 0.046 | 4 | 0 |
| `SneakGear.Inventory.PlayerInventoryComponent.NearbyPickupRespectsRange` | Passed | 0.054 | 4 | 0 |
| `SneakGear.Inventory.PlayerInventoryComponent.NearbyWeaponPickupHoldSwapsWithFloorItem` | Passed | 0.047 | 10 | 0 |
| `SneakGear.Inventory.PlayerInventoryComponent.NearbyWeaponPickupRequiresHoldToSwap` | Passed | 0.047 | 7 | 0 |
| `SneakGear.Inventory.PlayerInventoryComponent.PickupReportsEventAndStoresUtilityItem` | Passed | 0.047 | 4 | 0 |
| `SneakGear.Inventory.PlayerInventoryComponent.ReloadConsumesReserveAmmo` | Passed | 0.046 | 10 | 0 |
| `SneakGear.Inventory.PlayerInventoryComponent.ReloadWaitsForWeaponDelay` | Passed | 0.048 | 12 | 0 |
| `SneakGear.Inventory.PlayerInventoryComponent.UtilityScannerReportsNearbyGuards` | Passed | 0.047 | 6 | 0 |
| `SneakGear.Inventory.PlayerInventoryComponent.WeaponPickupSpawnsAndSelectsRuntimeWeapon` | Passed | 0.046 | 8 | 0 |
| `SneakGear.Player.SneakGearPlayerCharacter.CrouchCoverAllowsVault` | Passed | 0.046 | 7 | 0 |
| `SneakGear.Player.SneakGearPlayerCharacter.FullInputFlow` | Passed | 0.047 | 10 | 0 |
| `SneakGear.Player.SneakGearPlayerCharacter.PrimarySwapEquipsPickedUpWeapon` | Passed | 0.047 | 15 | 0 |
| `SneakGear.Player.SneakGearPlayerCharacter.ProneCannotVault` | Passed | 0.046 | 6 | 0 |
| `SneakGear.Player.SneakGearPlayerCharacter.SecondaryPickupKeepsPrimaryActive` | Passed | 0.047 | 11 | 0 |
| `SneakGear.Player.SneakGearPlayerCharacter.StandingCoverAllowsVault` | Passed | 0.046 | 5 | 0 |
| `SneakGear.Player.SneakGearPlayerCharacter.WeaponPickupEquipsWeapon` | Passed | 0.046 | 7 | 0 |
| `SneakGear.UI.EventFeedWidget.ShowsGuardStartedFiringNotification` | Passed | 0.046 | 3 | 0 |
| `SneakGear.UI.EventFeedWidget.ShowsPlayerDamageNotification` | Passed | 0.047 | 4 | 0 |
| `SneakGear.UI.EventFeedWidget.UpdatesFromEventDelegate` | Passed | 0.046 | 0 | 0 |
| `SneakGear.UI.PickupPromptWidget.ShowsSwapMessageAndHoldProgress` | Passed | 0.046 | 0 | 0 |
| `SneakGear.UI.PlayerVitalsWidget.UpdatesFromAttributeDelegates` | Passed | 0.045 | 4 | 0 |
| `SneakGear.UI.StanceWidget.UpdatesFromStanceDelegate` | Passed | 0.047 | 5 | 0 |
| `SneakGear.Weapon.WeaponBase.UsesAimProviderWithoutCamera` | Passed | 0.046 | 0 | 0 |
| `SneakGear.Weapon.WeaponBase.UsesAnimationDrivenFireInterval` | Passed | 0.046 | 0 | 0 |
