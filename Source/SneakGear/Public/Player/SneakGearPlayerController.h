...
#include "SneakGearPlayerController.generated.h"
...
UCLASS()
class SNEAKGEAR_API ASneakGearPlayerController : public APlayerController, public IWeaponMenuActions
{
	GENERATED_BODY()

public:
	ASneakGearPlayerController();
