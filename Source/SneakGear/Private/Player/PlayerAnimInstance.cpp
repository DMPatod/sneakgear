...
void UPlayerAnimInstance::NativeInitializeAnimation()
{
	...
	ThirdPersonCharacter = Cast<APlayerCharacterBase>(TryGetPawnOwner());
...
void UPlayerAnimInstance::NativeUpdateAnimation(float DeltaSeconds)
{
	...
	if (const ASneakGearPlayerCharacter* StealthCharacter = Cast<ASneakGearPlayerCharacter>(ThirdPersonCharacter))
	{
